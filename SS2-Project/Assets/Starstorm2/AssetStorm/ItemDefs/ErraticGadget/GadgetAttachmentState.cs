...
namespace EntityStates.ErraticGadget
{
    public class GadgetAttachmentState : BaseBodyAttachmentState
    {
        ...
        private bool DeleteNearbyProjectile()
        {
            ...
            float num = GadgetAttachmentState.projectileEraserRadius * GadgetAttachmentState.projectileEraserRadius;
            int num2 = 0;
